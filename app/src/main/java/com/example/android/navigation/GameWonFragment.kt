...
class GameWonFragment : Fragment() {
    ...
    private fun getShareIntent(): Intent {
        //said to be predefined GameWonFragmentArgs
        //BUNDLE
        val args = GameWonFragmentArgs.fromBundle(requireArguments())
        var intent: Intent = Intent(Intent.ACTION_SENDTO);
        //Opening outlook only
        // return intent.setType("text/plain").putExtra(Intent.EXTRA_TEXT,
          //      getString(R.string.share_success_text, args.numCorrect, args.numQuestions))
         intent=ShareCompat.IntentBuilder.from(activity!!).setText(getString(R.string.share_success_text,
